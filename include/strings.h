...
extern const u8 gText_RepelEffectsStepsRemaining[];
...
extern const u8 gText_ToggleShinyPokedex[];
...
extern const u8 gText_RegionMap_AreaDesc_VermilionHarbor[];
extern const u8 gText_RegionMap_AreaDesc_VictoryRoad[];
extern const u8 gText_RegionMap_AreaDesc_RocketHideout[];
extern const u8 gText_RegionMap_AreaDesc_RocketWarehouse[];
extern const u8 gText_RegionMap_AreaDesc_SilphCo[];
...
extern const u8 gText_RegionMap_AreaDesc_Tohjo_Falls[];
extern const u8 gText_RegionMap_AreaDesc_Dark_Cave[];
extern const u8 gText_RegionMap_AreaDesc_Dragons_Den[];
extern const u8 gText_RegionMap_AreaDesc_Ice_Path[];
extern const u8 gText_RegionMap_AreaDesc_Lake_Of_Rage[];
extern const u8 gText_RegionMap_AreaDesc_Mt_Mortar[];
extern const u8 gText_RegionMap_AreaDesc_Bell_Tower[];
extern const u8 gText_RegionMap_AreaDesc_Burned_Tower[];
extern const u8 gText_RegionMap_AreaDesc_Sprout_Tower[];
extern const u8 gText_RegionMap_AreaDesc_Ruins_Of_Alph[];
extern const u8 gText_RegionMap_AreaDesc_Union_Cave[];
extern const u8 gText_RegionMap_AreaDesc_Ruins_Of_Alph[];
extern const u8 gText_RegionMap_AreaDesc_Slowpoke_Well[];
extern const u8 gText_RegionMap_AreaDesc_Ilex_Forest[];
extern const u8 gText_RegionMap_AreaDesc_National_Park[];
extern const u8 gText_RegionMap_AreaDesc_Olivine_Lighthouse[];
extern const u8 gText_RegionMap_AreaDesc_Whirl_Islands[];
extern const u8 gText_RegionMap_AreaDesc_Cliff_Edge_Gate[];
extern const u8 gText_RegionMap_AreaDesc_Embedded_Tower[];
extern const u8 gText_RegionMap_AreaDesc_Mt_Silver[];
extern const u8 gText_RegionMap_AreaDesc_Unity_Tower[];
...
extern const u8 gText_QuestLog_PlayerBattledChampionLance[];
extern const u8 gText_QuestLog_PlayerSentOutMon1LanceSentOutMon2[];
...
extern const u8 gText_UsedGBSounds[];
