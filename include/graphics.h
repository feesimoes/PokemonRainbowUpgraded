...
extern const u8 gMonFootprint_BurmyPlant[];
...
extern const u8 gMonFootprint_BurmySandy[];
...
extern const u8 gMonFootprint_BurmyTrash[];
...
extern const u8 gMonFootprint_WormadamPlant[];
...
extern const u8 gMonFootprint_WormadamSandy[];
...
extern const u8 gMonFootprint_WormadamTrash[];
...
extern const u8 gMonFootprint_CherrimOvercast[];
...
extern const u8 gMonFootprint_CherrimSunshine[];
...
extern const u8 gMonFootprint_ShellosWest[];
...
extern const u8 gMonFootprint_ShellosEast[];
...
extern const u8 gMonFootprint_GastrodonWest[];
...
extern const u8 gMonFootprint_GastrodonEast[];
...
extern const u8 gMonFootprint_GiratinaAltered[];
...
extern const u8 gMonFootprint_ShayminLand[];
...
extern const u8 gMonFootprint_ShayminSky[];

extern const u32 gMonFrontPic_ArceusNormal[];
extern const u32 gMonPalette_ArceusNormal[];
extern const u32 gMonBackPic_ArceusNormal[];
...
extern const u32 gTrainerFrontPic_LeaderByron[];
extern const u32 gTrainerFrontPic_TrainerRodolfo[];
...
extern const u32 gTrainerPalette_LeaderByron[];
extern const u32 gTrainerPalette_TrainerRodolfo[];
