...
struct PokemonSubstruct3
{
 ...
 /* 0x0B */ u32 rainbowLocationFactor:4;    // Discarded in Gen 4. Repurposed here to determine if it came from a newer map within PokeRainbow by adding 256 per each increment of 1.
...
struct BattlePokemon
{
    ...
    /*0x21*/ u8 type1;
    /*0x22*/ u8 type2;
    /*0x23*/ u8 speciesFormsValue; // Originally "unknown", repurposed for expanded species/forms.
...
u8 GetExpandedFromMapSectionId(s8 mapSectionId);
