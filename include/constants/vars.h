...
#define VAR_MUSIC_PLAYER_TRACK             0x4029
...
#define VAR_TIME_DAYS_PLAYED       0x4098 // Tracks how many days have passed for time-based events. (Limit is roughly 65,535 days)
