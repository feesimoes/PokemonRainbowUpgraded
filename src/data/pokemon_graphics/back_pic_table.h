const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(BURMY_PLANT, gMonBackPic_BurmyPlant),
    SPECIES_SPRITE(BURMY_SANDY, gMonBackPic_BurmySandy),
    SPECIES_SPRITE(BURMY_TRASH, gMonBackPic_BurmyTrash),
    SPECIES_SPRITE(WORMADAM_PLANT, gMonBackPic_WormadamPlant),
    ...
    SPECIES_SPRITE(SHELLOS_WEST, gMonBackPic_ShellosWest),
    SPECIES_SPRITE(SHELLOS_EAST, gMonBackPic_ShellosEast),
    SPECIES_SPRITE(GASTRODON_WEST, gMonBackPic_GastrodonWest),
    SPECIES_SPRITE(GASTRODON_EAST, gMonBackPic_GastrodonEast),
    ...
    SPECIES_SPRITE(GIRATINA, gMonBackPic_GiratinaAltered),
    ...
    SPECIES_SPRITE(ARCEUS_NORMAL, gMonBackPic_ArceusNormal),
    ...
    SPECIES_SPRITE(SANDSHREW_ALOLA, gMonBackPic_Sandshrew_Alola),
    SPECIES_SPRITE(SANDSLASH_ALOLA, gMonBackPic_Sandslash_Alola),
    SPECIES_SPRITE(GEODUDE_ALOLA, gMonBackPic_Geodude_Alola),
    SPECIES_SPRITE(GRAVELER_ALOLA, gMonBackPic_Graveler_Alola),
    SPECIES_SPRITE(GOLEM_ALOLA, gMonBackPic_Golem_Alola),
    SPECIES_SPRITE(EXEGGUTOR_ALOLA, gMonBackPic_Exeggutor_Alola),
    SPECIES_SPRITE(MAROWAK_ALOLA, gMonBackPic_Marowak_Alola),
};
