const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(BURMY_PLANT, gMonPalette_BurmyPlant),
    SPECIES_PAL(BURMY_SANDY, gMonPalette_BurmySandy),
    SPECIES_PAL(BURMY_TRASH, gMonPalette_BurmyTrash),
    SPECIES_PAL(WORMADAM_PLANT, gMonPalette_WormadamPlant),
    ...
    SPECIES_PAL(SHELLOS_WEST, gMonPalette_ShellosWest),
    SPECIES_PAL(SHELLOS_EAST, gMonPalette_ShellosEast),
    SPECIES_PAL(GASTRODON_WEST, gMonPalette_GastrodonWest),
    SPECIES_PAL(GASTRODON_EAST, gMonPalette_GastrodonEast),
    ...
    SPECIES_PAL(GIRATINA, gMonPalette_GiratinaAltered),
    ...
    SPECIES_PAL(SANDSHREW_ALOLA, gMonPalette_Sandshrew_Alola),
    SPECIES_PAL(SANDSLASH_ALOLA, gMonPalette_Sandslash_Alola),
    SPECIES_PAL(GEODUDE_ALOLA, gMonPalette_Geodude_Alola),
    SPECIES_PAL(GRAVELER_ALOLA, gMonPalette_Graveler_Alola),
    SPECIES_PAL(GOLEM_ALOLA, gMonPalette_Golem_Alola),
    SPECIES_PAL(EXEGGUTOR_ALOLA, gMonPalette_Exeggutor_Alola),
