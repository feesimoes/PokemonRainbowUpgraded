const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(BURMY_PLANT, gMonFrontPic_BurmyPlant),
    SPECIES_SPRITE(BURMY_SANDY, gMonFrontPic_BurmySandy),
    SPECIES_SPRITE(BURMY_TRASH, gMonFrontPic_BurmyTrash),
    SPECIES_SPRITE(WORMADAM_PLANT, gMonFrontPic_WormadamPlant),
    ...
    SPECIES_SPRITE(SHELLOS_WEST, gMonFrontPic_ShellosWest),
    SPECIES_SPRITE(SHELLOS_EAST, gMonFrontPic_ShellosEast),
    SPECIES_SPRITE(GASTRODON_WEST, gMonFrontPic_GastrodonWest),
    SPECIES_SPRITE(GASTRODON_EAST, gMonFrontPic_GastrodonEast),
    ...
    SPECIES_SPRITE(GIRATINA, gMonFrontPic_GiratinaAltered),
    ...
    SPECIES_SPRITE(ARCEUS_NORMAL, gMonFrontPic_ArceusNormal),
    ...
    SPECIES_SPRITE(SANDSHREW_ALOLA, gMonFrontPic_Sandshrew_Alola),
    SPECIES_SPRITE(SANDSLASH_ALOLA, gMonFrontPic_Sandslash_Alola),
    SPECIES_SPRITE(GEODUDE_ALOLA, gMonFrontPic_Geodude_Alola),
    SPECIES_SPRITE(GRAVELER_ALOLA, gMonFrontPic_Graveler_Alola),
    SPECIES_SPRITE(GOLEM_ALOLA, gMonFrontPic_Golem_Alola),
    SPECIES_SPRITE(EXEGGUTOR_ALOLA, gMonFrontPic_Exeggutor_Alola),
    SPECIES_SPRITE(MAROWAK_ALOLA, gMonFrontPic_Marowak_Alola),
};
