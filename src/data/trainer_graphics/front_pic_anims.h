...
static const union AnimCmd *const sAnims_LeaderByron[] =
{
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_TrainerRodolfo[] =
{
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_LeaderKurt[] =
{
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_LEADER_BYRON]          = sAnims_LeaderByron,
    [TRAINER_PIC_RODOLFO]               = sAnims_TrainerRodolfo,
    ...
    [TRAINER_PIC_LEADER_KURT]           = sAnims_LeaderKurt,
};
