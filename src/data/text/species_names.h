const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_SHELLOS_EAST] = _("SHELLOS"),
    [SPECIES_GASTRODON_WEST] = _("GASTRODON"),
    [SPECIES_GASTRODON_EAST] = _("GASTRODON"),
    ...
    [SPECIES_SANDSHREW_ALOLA] = _("SANDSHREW"),
    [SPECIES_SANDSLASH_ALOLA] = _("SANDSLASH"),
    [SPECIES_GEODUDE_ALOLA] = _("GEODUDE"),
    [SPECIES_GRAVELER_ALOLA] = _("GRAVELER"),
    [SPECIES_GOLEM_ALOLA] = _("GOLEM"),
    [SPECIES_EXEGGUTOR_ALOLA] = _("EXEGGUTOR"),
    [SPECIES_MAROWAK_ALOLA] = _("MAROWAK"),
};
