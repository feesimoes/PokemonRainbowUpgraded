...
const u8 gText_QuestLog_PlayerBattledChampionLance[] = _("{PLAYER} had a marvelous battle\nwith the new CHAMPION, LANCE!");
const u8 gText_QuestLog_PlayerSentOutMon1LanceSentOutMon2[] = _("In the end, {DYNAMIC 0x00} sent out {DYNAMIC 0x01}\nwhile LANCE countered with\n{DYNAMIC 0x03}.");
