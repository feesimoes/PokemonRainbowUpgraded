...
const u16 gObjectEventPic_Steven[] = INCBIN_U16("graphics/object_events/pics/people/steven.4bpp");
const u16 gObjectEventPal_Steven[] = INCBIN_U16("graphics/object_events/palettes/npc_steven.gbapal");
const u16 gObjectEventPal_ApricornTrees[] = INCBIN_U16("graphics/object_events/palettes/apricorn_trees.gbapal");
const u16 gObjectEventPic_ApricornTree[] = INCBIN_U16("graphics/object_events/pics/misc/apricorn_tree_brown.4bpp");
const u16 gObjectEventPic_ApricornTree_Black[] = INCBIN_U16("graphics/object_events/pics/misc/apricorn_tree_black.4bpp");
const u16 gObjectEventPic_ApricornTree_Blue[] = INCBIN_U16("graphics/object_events/pics/misc/apricorn_tree_blue.4bpp");
const u16 gObjectEventPic_ApricornTree_Green[] = INCBIN_U16("graphics/object_events/pics/misc/apricorn_tree_green.4bpp");
const u16 gObjectEventPic_ApricornTree_Pink[] = INCBIN_U16("graphics/object_events/pics/misc/apricorn_tree_pink.4bpp");
const u16 gObjectEventPic_ApricornTree_Red[] = INCBIN_U16("graphics/object_events/pics/misc/apricorn_tree_red.4bpp");
const u16 gObjectEventPic_ApricornTree_White[] = INCBIN_U16("graphics/object_events/pics/misc/apricorn_tree_white.4bpp");
const u16 gObjectEventPic_ApricornTree_Yellow[] = INCBIN_U16("graphics/object_events/pics/misc/apricorn_tree_yellow.4bpp");
