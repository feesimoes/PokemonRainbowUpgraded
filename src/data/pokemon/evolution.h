const struct Evolution gEvolutionTable[NUM_SPECIES + 1][EVOS_PER_MON] =
{
    ...
    [SPECIES_KADABRA]    = {{EVO_FRIENDSHIP_DAY, 0, SPECIES_ALAKAZAM}},
    ...
    [SPECIES_EXEGGCUTE]  = {{EVO_ITEM_ALOLAN, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR_ALOLA},
                            {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR}},
    [SPECIES_CUBONE]     = {{EVO_LEVEL, 28, SPECIES_MAROWAK},
                            {EVO_LEVEL_ALOLAN, 28, SPECIES_MAROWAK_ALOLA}},
    [SPECIES_LICKITUNG]  = {{EVO_LEVEL, 33, SPECIES_LICKILICKY}}, // Basically when it should learn Rollout
    [SPECIES_KOFFING]    = {{EVO_LEVEL, 35, SPECIES_WEEZING}},
    [SPECIES_RHYHORN]    = {{EVO_LEVEL, 42, SPECIES_RHYDON}},
    [SPECIES_RHYDON]     = {{EVO_FRIENDSHIP, 0, SPECIES_RHYPERIOR}},
    [SPECIES_CHANSEY]    = {{EVO_FRIENDSHIP, 0, SPECIES_BLISSEY}},
    [SPECIES_TANGELA]    = {{EVO_LEVEL, 40, SPECIES_TANGROWTH}}, // Roughly when it should learn Ancient Power
    ...
    [SPECIES_AIPOM]      = {{EVO_LEVEL, 32, SPECIES_AMBIPOM}}, //Roughly when it can learn Double Hit
    [SPECIES_SUNKERN]    = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_SUNFLORA}},
    [SPECIES_YANMA]      = {{EVO_LEVEL, 34, SPECIES_YANMEGA}}, //Roughly when it can learn Ancient Power
    [SPECIES_WOOPER]     = {{EVO_LEVEL, 20, SPECIES_QUAGSIRE}},
    [SPECIES_MURKROW]    = {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_HONCHKROW}},
    [SPECIES_MISDREAVUS] = {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_MISMAGIUS}},
    ...
    [SPECIES_FEEBAS]     = {{EVO_BEAUTY, 0, SPECIES_MILOTIC}}, // 170 is normally needed, Contests and PokeBlocks are not in yet
    ...
    [SPECIES_DUSCLOPS]   = {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_DUSKNOIR}},
    ...
    [SPECIES_BURMY_PLANT]   = {{EVO_LEVEL, 20, SPECIES_WORMADAM_PLANT}},
    [SPECIES_BURMY_SANDY]   = {{EVO_LEVEL, 20, SPECIES_WORMADAM_SANDY}},
    [SPECIES_BURMY_TRASH]   = {{EVO_LEVEL, 20, SPECIES_WORMADAM_TRASH}},
    [SPECIES_WORMADAM_PLANT]   = {{EVO_LEVEL, 30, SPECIES_MOTHIM}},
    [SPECIES_WORMADAM_SANDY]   = {{EVO_LEVEL, 30, SPECIES_MOTHIM}},
    [SPECIES_WORMADAM_TRASH]   = {{EVO_LEVEL, 30, SPECIES_MOTHIM}},
    [SPECIES_COMBEE]     = {{EVO_LEVEL, 21, SPECIES_VESPIQUEN}},
    [SPECIES_BUIZEL]     = {{EVO_LEVEL, 26, SPECIES_FLOATZEL}},
    [SPECIES_CHERUBI]    = {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_CHERRIM_OVERCAST},
                            {EVO_FRIENDSHIP_DAY, 0, SPECIES_CHERRIM_SUNSHINE}},
    [SPECIES_SHELLOS_WEST]     = {{EVO_LEVEL, 30, SPECIES_GASTRODON_WEST}},
    [SPECIES_SHELLOS_EAST]     = {{EVO_LEVEL, 30, SPECIES_GASTRODON_EAST}},
    ...
    [SPECIES_BONSLY]     = {{EVO_LEVEL, 16, SPECIES_SUDOWOODO}}, // Roughly when it learns Mimic
    [SPECIES_MIME_JR]     = {{EVO_LEVEL, 32, SPECIES_MR_MIME}}, // Roughly when it learns Mimic
    ...
    [SPECIES_GRAVELER_ALOLA] = {{EVO_FRIENDSHIP, 0, SPECIES_GOLEM_ALOLA}},
};
