...
const u8 gText_ToggleShinyPokedex[] = _("{CIRCLE_DOT}TOGGLE SHINY POKéDEX (PRESS START) {DPAD_UPDOWN}PICK {A_BUTTON}OK ");
...
const u8 gText_RepelEffectsStepsRemaining[] = _("{PLAYER} used the REPEL,\n{STR_VAR_1} steps remaining!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ReleaseThisPokemon[] = _("Transfer this POKéMON?");
const u8 gText_PkmnWasReleased[] = _("OAK: Excellent work!");
const u8 gText_ByeByePkmn[] = _("Obtained one Rare Candy!");
...
const u8 gText_YouCantReleaseAnEgg[] = _("You can't transfer an EGG.");
...
const u8 gPCText_Release[] = _("TRANSFER");
...
const u8 gText_RegionMap_UpDownPick[] = _("{DPAD_ANY}PICK");
...
const u8 gText_RegionMap_AreaDesc_VermilionHarbor[] = _("A local port right off the coast\nof VERMILION CITY.\nIt is famous for the S.S. ANNE,\nwhich visits once a year.");
...
const u8 gText_RegionMap_AreaDesc_RocketHideout[] = _("A barely-hid button behind the\nposter in CELADON'S GAME CORNER\nexposed TEAM ROCKET'S base of\noperations. It's widely known now.");
const u8 gText_RegionMap_AreaDesc_RocketWarehouse[] = _("A promptly-built warehouse\nin FIVE ISLE MEADOW.\nIt's TEAM ROCKET'S attempt\nat regrouping efforts.");
const u8 gText_RegionMap_AreaDesc_SilphCo[] = _("The MAIN OFFICE building for the\nSILPH CORPORATION, which is the\nleading manufacturer of high-tech\ngoods sold across the globe.");
...
const u8 gText_RegionMap_AreaDesc_SeafoamIslands[] = _("A pair of islands that are situated\non ROUTE 20.\nThe two islands are shaped the\nsame, as if they were twins.");
...
const u8 gText_RegionMap_AreaDesc_Tohjo_Falls[] = _("The waterfall that links the\nKANTO and JOHTO regions.\nDespite popular belief, there's\nno actual TOHJO REGION...");
const u8 gText_RegionMap_AreaDesc_Dark_Cave[] = _("A dark, difficult-to-navigate\ntunnel that runs beneath the\nJOHTO region.\nA light source is recommended.");
const u8 gText_RegionMap_AreaDesc_Dragons_Den[] = _("The ultimate test for TRAINERS.\nCountless legends, forged here...\nThe DRAGON'S SHRINE is within.");
const u8 gText_RegionMap_AreaDesc_Ice_Path[] = _("A freezing tunnel that connects\nROUTE 44 to BLACKTHORN CITY.\nDue to its proximity to the peak\nof MT. SILVER, it's always cold.");
const u8 gText_RegionMap_AreaDesc_Lake_Of_Rage[] = _("A huge lake, full of water.\nGYARADOS regularly make it rain.\nVery rarely, visitors report on\nit being sunny on WEDNESDAY.");
const u8 gText_RegionMap_AreaDesc_Mt_Mortar[] = _("Not much is known about it,\nexcept it's a mountain.");
const u8 gText_RegionMap_AreaDesc_Bell_Tower[] = _("Not much is known about it,\nexcept it's a tower.");
const u8 gText_RegionMap_AreaDesc_Burned_Tower[] = _("Formerly named BRASS TOWER,\nit was destroyed by some\nmysterious flames... LUGIA'S\nnew home is in WHIRL ISLANDS.");
const u8 gText_RegionMap_AreaDesc_Sprout_Tower[] = _("A tower up to 3F, SAGES\nstudy diligently to learn\nhow to live with POKéMON.\nIt's about 100 feet tall!");
const u8 gText_RegionMap_AreaDesc_Ruins_Of_Alph[] = _("Not much is known about it,\nexcept that it's ruins.");
const u8 gText_RegionMap_AreaDesc_Union_Cave[] = _("Not much is known about it,\nexcept that it's a cave.");
const u8 gText_RegionMap_AreaDesc_Slowpoke_Well[] = _("Not much is known about it,\nexcept that it's a well.");
const u8 gText_RegionMap_AreaDesc_Ilex_Forest[] = _("Not much is known about it,\nexcept that it's a forest.");
const u8 gText_RegionMap_AreaDesc_National_Park[] = _("Not much is known about it,\nexcept that it's a park.");
const u8 gText_RegionMap_AreaDesc_Olivine_Lighthouse[] = _("Not much is known about it,\nexcept it's a lighthouse.");
const u8 gText_RegionMap_AreaDesc_Whirl_Islands[] = _("Not much is known about it,\nexcept it's 4 islands.");
const u8 gText_RegionMap_AreaDesc_Cliff_Edge_Gate[] = _("Not much is known about it,\nexcept it's a gate.");
const u8 gText_RegionMap_AreaDesc_Embedded_Tower[] = _("Not much is known about it,\nexcept it's a tower.");
const u8 gText_RegionMap_AreaDesc_Mt_Silver[] = _("Not much is known about it,\nexcept it's a mountain.");
const u8 gText_RegionMap_AreaDesc_Unity_Tower[] = _("A tall skyscraper in the UNOVA\nREGION, where people from all\nover the world can communicate.");
...
const u8 gText_WildBattleMode[] = _("WILD BATTLE MODE");
const u8 gText_WildBattleModeGO[] = _("GO");
const u8 gText_WildBattleModeStandard[] = _("STANDARD");
...
const u8 gText_UsedGBSounds[] = _("{PLAYER} used the GB SOUNDS.");
