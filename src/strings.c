...
const u8 gText_RegionMap_AreaDesc_Ice_Path[] = _("Soon (tm)");
const u8 gText_RegionMap_AreaDesc_Lake_Of_Rage[] = _("Soon (tm)");
const u8 gText_RegionMap_AreaDesc_Mt_Mortar[] = _("Soon (tm)");
const u8 gText_RegionMap_AreaDesc_Bell_Tower[] = _("Soon (tm)");
...
const u8 gText_RegionMap_AreaDesc_Ruins_Of_Alph[] = _("Soon (tm)");
const u8 gText_RegionMap_AreaDesc_Union_Cave[] = _("Soon (tm)");
const u8 gText_RegionMap_AreaDesc_Slowpoke_Well[] = _("Soon (tm)");
const u8 gText_RegionMap_AreaDesc_Ilex_Forest[] = _("Soon (tm)");
const u8 gText_RegionMap_AreaDesc_National_Park[] = _("Soon (tm)");
const u8 gText_RegionMap_AreaDesc_Olivine_Lighthouse[] = _("Soon (tm)");
const u8 gText_RegionMap_AreaDesc_Whirl_Islands[] = _("Soon (tm)");
const u8 gText_RegionMap_AreaDesc_Cliff_Edge_Gate[] = _("Soon (tm)");
const u8 gText_RegionMap_AreaDesc_Embedded_Tower[] = _("Soon (tm)");
const u8 gText_RegionMap_AreaDesc_Mt_Silver[] = _("Soon (tm)");
