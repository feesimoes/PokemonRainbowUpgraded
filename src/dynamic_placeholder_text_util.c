...
//  [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    ...
    [OBJ_EVENT_GFX_CYNTHIA / 2]                 = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_CLAIR
    [OBJ_EVENT_GFX_WEIRD_TREE / 2]              = COLORS(NPC_TEXT_COLOR_MON, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_SILVER
    [OBJ_EVENT_GFX_NORMAN / 2]                  = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_KURT
    [OBJ_EVENT_GFX_CALYPSO / 2]                 = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_WALKER
    [OBJ_EVENT_GFX_WHIRLPOOL / 2]               = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_STEVEN
    [OBJ_EVENT_GFX_APRICORN_TREE / 2]           = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_APRICORN_TREE_BLACK
    [OBJ_EVENT_GFX_APRICORN_TREE_BLUE / 2]      = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_APRICORN_TREE_GREEN
    [OBJ_EVENT_GFX_APRICORN_TREE_PINK / 2]      = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_APRICORN_TREE_RED
    [OBJ_EVENT_GFX_APRICORN_TREE_WHITE / 2]     = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_APRICORN_TREE_YELLOW
};
