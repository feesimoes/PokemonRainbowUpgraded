...
static const u8 sDungeonMaps[][3] = {
    ...
    { MAP_GROUP(MAP_TOHJO_FALLS_B1F), MAP_NUM(MAP_TOHJO_FALLS_B1F), 1 },
    { MAP_GROUP(MAP_TOHJO_FALLS_B2F), MAP_NUM(MAP_TOHJO_FALLS_B2F), 2 },
    { MAP_GROUP(MAP_TOHJO_FALLS_B3F), MAP_NUM(MAP_TOHJO_FALLS_B3F), 3 },
    { MAP_GROUP(MAP_TOHJO_FALLS_B4F), MAP_NUM(MAP_TOHJO_FALLS_B4F), 4 },
    { MAP_GROUP(MAP_TOHJO_FALLS_B5F), MAP_NUM(MAP_TOHJO_FALLS_B5F), 5 },
    { MAP_GROUP(MAP_TOHJO_FALLS_B6F), MAP_NUM(MAP_TOHJO_FALLS_B6F), 6 },
    { MAP_GROUP(MAP_TOHJO_FALLS_B7F), MAP_NUM(MAP_TOHJO_FALLS_B7F), 7 },
    { MAP_GROUP(MAP_TOHJO_FALLS_B8F), MAP_NUM(MAP_TOHJO_FALLS_B8F), 8 }
};
