...
bool32 Overworld_MusicCanOverrideMapMusic(u16 music)
{
    ...
    {
        if (gMapHeader.regionMapSectionId == MAPSEC_KANTO_VICTORY_ROAD || gMapHeader.regionMapSectionId == MAPSEC_ROUTE_23 || gMapHeader.regionMapSectionId == MAPSEC_INDIGO_PLATEAU || gMapHeader.regionMapSectionId == MAPSEC_TOHJO_FALLS)
            return FALSE;
    }
    return TRUE;
}
